...
class TextDecoration internal constructor(val mask: Int) {
    ...
    companion object {
         ...
         *
         * @sample com.tencent.kuikly.compose.ui.text.samples.TextDecorationUnderlineSample
         */
        @Stable
         ...
         *
         * @sample com.tencent.kuikly.compose.ui.text.samples.TextDecorationCombinedSample
         *
