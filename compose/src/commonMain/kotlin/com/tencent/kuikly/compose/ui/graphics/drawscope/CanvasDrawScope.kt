...
import com.tencent.kuikly.compose.ui.geometry.center
...
//        blendMode: BlendMode
        ...
        paint = configurePaint(brush, style, alpha)
    )
...
//        blendMode: BlendMode
        ...
        cornerRadius.x,
        cornerRadius.y,
        configurePaint(brush, style, alpha)
    )
...
//        blendMode: BlendMode
        ...
        cornerRadius.x,
        cornerRadius.y,
        configurePaint(color, style, alpha)
    )
...
//            blendMode
    ...
    private fun obtainFillPaint(): Paint =
        fillPaint ?: KuiklyPaint().apply { style = PaintingStyle.Fill }.also {
            fillPaint = it
        }
    ...
    private fun obtainStrokePaint(): Paint =
        strokePaint ?: KuiklyPaint().apply { style = PaintingStyle.Stroke }.also {
            strokePaint = it
        }
...
//        if (this.filterQuality != filterQuality) this.filterQuality = filterQuality
    ...
    @PublishedApi internal data class DrawParams(
        ...
        var canvas: Canvas = KuiklyCanvas(),
